...
from water_flow import reynolds_number, pressure_loss_from_fittings, pressure_loss_from_pipe_reduction
# to this test code that uses pytest to test the function.
...
def test_reynolds_number():
    assert reynolds_number(0.0, 0.0) == approx(0, abs=1)
